    ...
    async def weather_task(self):
        ...
        if channel:
            ...
            meteo_options = [
                ...
                {"msg": "Prévoyez le parapluie, il pleut sur le château. 🌧️", "https://media.discordapp.net/attachments/1362231762197156264/1474885824188383294/image.png?ex=699d7436&is=699c22b6&hm=43e00f1c8cdc2817e6138642befc61d1d235786a2ef623e54581a63a2d970af2&=&format=webp&quality=lossless&width=570&height=800"},
