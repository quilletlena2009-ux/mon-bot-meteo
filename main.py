...
class MyBot(commands.Bot):
    ...
    async def weather_task(self):
        ...
        if channel:
            msg, img = self.get_meteo_info()
            embed = discord.Embed(title="Météo du jour", description=msg, color=0x3498db, timestamp=datetime.datetime.now())
    ...
    def get_meteo_info(self):
        ...
        return random.choices(options, weights=[10, 10, 10, 10, 2], k=1)[0]
